...
public class ReportSteps {
    ...
    private final ExternalService externalServiceMock;
    ...
    public ReportSteps() {
        ...
        this.externalServiceMock = Mockito.mock(ExternalService.class);

        //inject mocks
        this.gestore = new GestoreCorsiDiStudioConservatorio(
            courseDaoMock, teacherDaoMock, examDaoMock, studentDaoMock, reportDaoMock, externalServiceMock
        );
