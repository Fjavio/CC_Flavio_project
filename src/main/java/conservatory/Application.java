...
public class Application {
    ...
    @Bean
    public GestoreCorsiDiStudioConservatorio gestore(CorsoDAO courseDAO, DocenteDAO teacherDAO,EsameDAO examDAO, StudenteDAO studentDAO,VerbaleDAO reportDAO) {
    	//Spring automatically injects all DAO Beans (created above), into the Gestore constructor.
        return new GestoreCorsiDiStudioConservatorio(courseDAO, teacherDAO, examDAO, studentDAO, reportDAO);
    }
}
